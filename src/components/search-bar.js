   ...
   constructor(props){
    ...
    render(){
        ...
        <div className="col-md-8 input-group">
         ...
         <button className="btn btn-secondary" onClick={this.handleOnClick.bind(this)}><img className="icon-search" src="icon-search.png"/> Go!</button>
         </span>
         </div>
        </div>
        )
